...
MICROSCOPY_TECHNIQUES = {
    ...
    'DIC': [r'\bdic\b.*(?:microscop|imag|optic)', 'differential interference contrast'],
    ...
    # Functional imaging
    'FRET': ['fret', r'f̦rster resonance', 'fluorescence resonance energy transfer'],
    'FLIM': ['flim', 'fluorescence lifetime'],
    'FRAP': ['frap', 'fluorescence recovery after photobleaching'],
    'FLIP': [r'\bflip\b.*(?:experiment|assay|photobleach|fluorescence)', 'fluorescence loss in photobleaching'],
    ...
    'OCT': ['optical coherence tomography', r'\boct\b.*(?:imag|scan|system|microscop|angiograph)'],
    'Photoacoustic': ['photoacoustic'],
    'AFM': ['atomic force microscop', r'\bafm\b.*(?:microscop|imag|tip|cantilever|topograph|scan|probe)', r'\bafm\b.*(?:measurement|mode|technique)'],
    ...
    'SRS': [r'\bsrs\b.*(?:microscop|imag|spectroscop)', 'stimulated raman scattering', r'stimulated raman\b'],
