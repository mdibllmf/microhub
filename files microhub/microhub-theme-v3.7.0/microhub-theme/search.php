...
<div class="mh-container">
    ...
    <div class="mh-author-header">
        <h2>ðŸ‘¤ <?php echo esc_html($search_query); ?></h2>
        <div class="mh-author-stats">
            <span>ðŸ“š <?php echo $wp_query->found_posts; ?> paper<?php echo $wp_query->found_posts !== 1 ? 's' : ''; ?></span>
            <?php
            ...
            wp_reset_postdata();
            ?>
            <span>ðŸ“Š <?php echo number_format($total_citations); ?> total citations</span>
        </div>
    </div>
    <?php endif; ?>
            ...
            <?php if (get_post_type() === 'mh_paper' && !empty($meta)): ?>
                ...
                <div style="display: flex; flex-wrap: wrap; gap: 8px; margin-top: 12px;">
                    ...
                    <?php if (!empty($meta['rrids'])): ?>
                        <span style="font-size: 0.8rem; color: #a371f7;">ðŸ·ï¸ <?php echo count($meta['rrids']); ?></span>
                    <?php endif; ?>
                </div>
            <?php else: ?>
                <div class="mh-card-meta">
