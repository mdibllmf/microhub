...
<div class="microhub-wrapper">
    ...
    <div class="mh-page-container">
        ...
        <section class="mh-about-section">
            <h2>ðŸ“ˆ Repository Statistics</h2>
            <?php
            global $wpdb;
        ...
        <section class="mh-about-section">
            ...
            <ul class="mh-contribute-list">
                <li>ðŸ“¤ <a href="<?php echo esc_url($urls['upload-protocol']); ?>">Uploading protocols</a> you've developed</li>
                <li>ðŸ“„ <a href="<?php echo esc_url($urls['upload-paper']); ?>">Submitting papers</a> we may have missed</li>
                <li>ðŸ’¬ <a href="<?php echo esc_url($urls['discussions']); ?>">Joining discussions</a> and sharing expertise</li>
                <li>ðŸ› Reporting issues or suggesting improvements</li>
            </ul>
        </section>
