...
<div class="mh-single-protocol">
    ...
    <article class="mh-protocol-article">
        ...
        <header class="mh-protocol-header">
            <div class="mh-protocol-badges">
                ...
                <span class="mh-protocol-citation-badge <?php echo esc_attr($citation_badge_class); ?>">
                    <?php 
                    if ($citations >= 100) echo 'ðŸ† Foundational';
                    elseif ($citations >= 50) echo 'â­ High Impact';
                ...
                <div class="mh-repositories-list">
                    ...
                    ?>
                        <a href="<?php echo esc_url($repo_url); ?>" class="mh-repository-link" target="_blank" rel="noopener">
                            ðŸ’¾ <?php echo esc_html($repo_name); ?>
                        </a>
                    <?php endforeach; ?>
                </div>
            </section>
        ...
        <?php if (!empty($rrids)): ?>
            <section class="mh-protocol-section">
                <h2>ðŸ·ï¸ Research Resource Identifiers (RRIDs)</h2>
                ...
                <div class="mh-protocols-list">
                    ...
                    ?>
                        <a href="<?php echo esc_url($proto_url); ?>" class="mh-protocol-link-item" target="_blank" rel="noopener">
                            ðŸ“‹ <?php echo esc_html($proto_name); ?>
                        </a>
                    <?php endforeach; ?>
                </div>
            </section>
