...
// Category info
$categories = array(
    'techniques' => array('icon' => 'ðŸ”¬', 'name' => 'Techniques'),
    'software' => array('icon' => 'ðŸ’»', 'name' => 'Software'),
    'protocols' => array('icon' => 'ðŸ“‹', 'name' => 'Protocols'),
    'qa' => array('icon' => 'â“', 'name' => 'Q&A'),
    'announcements' => array('icon' => 'ðŸ“¢', 'name' => 'Announcements'),
    'ideas' => array('icon' => 'ðŸ’¡', 'name' => 'Ideas'),
);
...
<div class="mh-single-discussion">
    ...
    <?php while (have_posts()) : the_post(); ?>
            ...
            <header class="mh-discussion-header">
                ...
                <div class="mh-discussion-meta">
                    ...
                    <span class="mh-reply-count">
                        ðŸ’¬ <?php echo count($replies); ?> <?php echo count($replies) === 1 ? 'reply' : 'replies'; ?>
                    </span>
                </div>
            </header>
        ...
        <section class="mh-replies-section">
            <h2>ðŸ’¬ Replies (<?php echo count($replies); ?>)</h2>
            
            <?php if ($reply_submitted): ?>
                <div class="mh-success-message">
                    <strong>âœ“ Reply posted!</strong> Your reply has been added to the discussion.
                </div>
            <?php endif; ?>
