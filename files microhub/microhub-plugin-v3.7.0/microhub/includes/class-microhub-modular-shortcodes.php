...
class MicroHub_Modular_Shortcodes {
    ...
    public function stats_bar_shortcode($atts) {
        ...
        $stats = array(
            'papers' => array('value' => wp_count_posts('mh_paper')->publish, 'label' => 'Papers', 'icon' => 'ðŸ“„'),
            'techniques' => array('value' => wp_count_terms('mh_technique'), 'label' => 'Techniques', 'icon' => 'ðŸ”¬'),
            'software' => array('value' => wp_count_terms('mh_software'), 'label' => 'Software', 'icon' => 'ðŸ’»'),
            'organisms' => array('value' => wp_count_terms('mh_organism'), 'label' => 'Organisms', 'icon' => 'ðŸ§¬'),
            'microscopes' => array('value' => wp_count_terms('mh_microscope'), 'label' => 'Microscopes', 'icon' => 'ðŸ”­'),
        );
        ...
        <div class="mh-enrichment-stats">
            ...
            <div class="mh-enrichment-grid">
                <div class="mh-enrichment-item">
                    <span class="mh-enrichment-icon">ðŸ“‹</span>
                ...
                <div class="mh-enrichment-item">
                    <span class="mh-enrichment-icon">ðŸ·ï¸</span>
        ...
        <div class="mh-featured-section">
            ...
            <div class="mh-featured-papers mh-layout-<?php echo esc_attr($atts['layout']); ?>">
                ...
                <div class="mh-featured-card">
                    <div class="mh-featured-badge">ðŸ† <?php echo number_format($citations); ?> citations</div>
