...
(function($) {
    ...
    MicroHub.getSmartAIResponse = function(message) {
        ...
        if (msg.includes('confocal') && (msg.includes('how') || msg.includes('what') || msg.includes('work'))) {
            response = '<strong>Confocal Microscopy</strong><br><br>' +
                ...
                '<strong>Key features:</strong><br>â€¢ Point-by-point laser scanning<br>â€¢ Pinhole blocks out-of-focus light<br>â€¢ Z-stacking for 3D reconstruction<br>â€¢ ~200nm lateral, ~500nm axial resolution<br><br>' +
                '<strong>Best for:</strong> Fixed samples, 3D imaging up to ~100Î¼m, colocalization<br><br>' +
                '<strong>Systems:</strong> Zeiss LSM 880/980, Leica SP8, Nikon A1, Olympus FV3000<br><br>' +
                'ðŸ’¡ <em>Tip: Use #1.5 coverslips and match immersion oil to objective.</em>';
        }
        else if (msg.includes('confocal')) {
            response = 'Confocal microscopy uses point illumination and a pinhole to eliminate out-of-focus light, producing sharp optical sections. Ideal for 3D imaging up to ~100Î¼m. Common systems: Zeiss LSM, Leica SP8, Nikon A1. Want more details on how it works?';
        }
        ...
        // TWO-PHOTON
            ...
            response = '<strong>Two-Photon Microscopy</strong><br><br>' +
                ...
                '<strong>Advantages:</strong><br>â€¢ Deep tissue penetration (up to 1mm)<br>â€¢ Reduced photobleaching<br>â€¢ Intrinsic optical sectioning<br>â€¢ Less scattering<br><br>' +
                '<strong>Best for:</strong> Live tissue, intravital imaging, neuroscience, developmental biology<br><br>' +
                'ðŸ’¡ <em>Tip: Use red-shifted indicators (GCaMP6/8, jRGECO) for deeper imaging.</em>';
        }
        ...
        // LIGHT SHEET
            ...
            response = '<strong>Light Sheet Microscopy (SPIM)</strong><br><br>' +
                ...
                '<strong>Advantages:</strong><br>â€¢ 100-1000x less photobleaching than confocal<br>â€¢ Fast (entire plane at once)<br>â€¢ Excellent for long-term live imaging<br><br>' +
                ...
                'ðŸ’¡ <em>Tip: Sample mounting is critical - use FEP tubes or low-melting agarose.</em>';
        }
        ...
        // TIRF
            ...
            response = '<strong>TIRF Microscopy</strong><br><br>' +
                ...
                '<strong>How it works:</strong><br>â€¢ Light hits glass/water at critical angle<br>â€¢ Creates decaying evanescent field<br>â€¢ Only near-membrane fluorophores excited<br><br>' +
                '<strong>Best for:</strong> Single molecules, membrane dynamics, vesicle fusion, receptor trafficking<br><br>' +
                'ðŸ’¡ <em>Tip: Clean coverslips are essential - use plasma cleaning.</em>';
        }
        ...
        // STED
            ...
            response = '<strong>STED Microscopy</strong><br><br>' +
                ...
                'ðŸ† <em>2014 Nobel Prize (Stefan Hell)</em>';
        }
        ...
        // STORM/PALM
            ...
            response = '<strong>STORM/PALM (~20nm resolution)</strong><br><br>' +
                ...
                '<strong>Requirements:</strong><br>â€¢ TIRF/HILO illumination<br>â€¢ High-power lasers<br>â€¢ EMCCD/sCMOS camera<br>â€¢ 10,000-50,000 frames<br><br>' +
                'ðŸ’¡ <em>Tip: Use fiducial markers for drift correction.</em>';
        }
        ...
        // SIM
            ...
            response = '<strong>SIM (Structured Illumination)</strong><br><br>' +
                ...
                '<strong>How it works:</strong><br>â€¢ Project stripe pattern on sample<br>â€¢ Rotate pattern (3-5 angles)<br>â€¢ Computationally extract high frequencies<br><br>' +
                '<strong>Advantages:</strong><br>â€¢ Works with standard dyes<br>â€¢ Relatively fast<br>â€¢ Good for live cells<br><br>' +
        ...
        // CRYO-EM
            ...
            response = '<strong>Cryo-Electron Microscopy</strong><br><br>' +
                ...
                '<strong>Single Particle:</strong> Purified proteins, 2-4Ã… possible<br>' +
                ...
                'ðŸ† <em>2017 Nobel Prize - revolutionized structural biology!</em>';
        }
        
        // FRET
        else if (msg.includes('fret')) {
            response = '<strong>FRET (FÃ¶rster Resonance Energy Transfer)</strong><br><br>' +
                'Non-radiative energy transfer when donor/acceptor are 1-10nm apart.<br><br>' +
                '<strong>Methods:</strong><br>â€¢ Sensitized emission<br>â€¢ Acceptor photobleaching<br>â€¢ FLIM-FRET (most quantitative)<br><br>' +
                ...
                'ðŸ’¡ <em>Use FLIM-FRET to avoid concentration artifacts.</em>';
        }
        ...
        // FLIM
            ...
            response = '<strong>FLIM (Fluorescence Lifetime Imaging)</strong><br><br>' +
                ...
                '<strong>Why lifetime?</strong><br>â€¢ Independent of concentration<br>â€¢ Sensitive to environment (pH, ions)<br>â€¢ Distinguishes overlapping spectra<br>â€¢ Quantitative FRET<br><br>' +
                '<strong>Applications:</strong> FRET, metabolic imaging (NAD(P)H), biosensors<br><br>' +
                'ðŸ’¡ <em>NAD(P)H lifetime reports on metabolic state.</em>';
        }
        ...
        // FRAP
            ...
            response = '<strong>FRAP (Fluorescence Recovery After Photobleaching)</strong><br><br>' +
                ...
                'ðŸ’¡ <em>Include reference region to correct for acquisition bleaching.</em>';
        }
        
        // CALCIUM IMAGING
        else if (msg.includes('calcium') || msg.includes('gcamp')) {
            response = '<strong>Calcium Imaging</strong><br><br>' +
                '<strong>Genetic indicators:</strong><br>â€¢ GCaMP6/7/8 (green, most popular)<br>â€¢ jRGECO/jRCaMP (red)<br><br>' +
                '<strong>Chemical dyes:</strong><br>â€¢ Fura-2 (ratiometric)<br>â€¢ Fluo-4, Cal-520 (green)<br><br>' +
                '<strong>Imaging:</strong> Two-photon for deep tissue, widefield for speed<br><br>' +
                'ðŸ’¡ <em>GCaMP8 has faster kinetics for resolving individual spikes.</em>';
        }
        ...
        // IMAGEJ/FIJI
            ...
            response = '<strong>ImageJ / Fiji</strong><br><br>' +
                ...
                '<strong>Capabilities:</strong><br>â€¢ Measurements, segmentation<br>â€¢ Colocalization analysis<br>â€¢ 3D visualization<br>â€¢ Macro scripting<br><br>' +
                '<strong>Essential plugins:</strong><br>â€¢ Bio-Formats, TrackMate<br>â€¢ StarDist, Cellpose<br>â€¢ MorphoLibJ<br><br>' +
                'ðŸ”— Download: <a href="https://fiji.sc" target="_blank">fiji.sc</a>';
        }
        ...
        // CELLPOSE
            ...
            response = '<strong>Cellpose</strong><br><br>' +
                ...
                '<strong>Features:</strong><br>â€¢ Pre-trained for cells/nuclei<br>â€¢ Works on diverse cell types<br>â€¢ GUI + Python + Fiji + Napari<br>â€¢ Custom training possible<br><br>' +
                'ðŸ’¡ <em>Cellpose 2.0 has improved models and human-in-the-loop training.</em><br><br>' +
                'ðŸ”— <a href="https://www.cellpose.org" target="_blank">cellpose.org</a>';
        }
        ...
        // CELLPROFILER
            ...
            response = '<strong>CellProfiler</strong><br><br>' +
                ...
                '<strong>Strengths:</strong><br>â€¢ No coding required<br>â€¢ Reproducible pipelines<br>â€¢ Hundreds of measurements<br>â€¢ High-content screening<br><br>' +
                'ðŸ”— <a href="https://cellprofiler.org" target="_blank">cellprofiler.org</a>';
        }
        ...
        // NAPARI
            ...
            response = '<strong>Napari</strong><br><br>' +
                ...
                '<strong>Features:</strong><br>â€¢ GPU-accelerated<br>â€¢ Layer-based (images, labels, points)<br>â€¢ Great plugin ecosystem<br><br>' +
                '<strong>Install:</strong> <code>pip install napari[all]</code><br><br>' +
                'ðŸ”— <a href="https://napari.org" target="_blank">napari.org</a>';
        }
        
        // SAMPLE PREP
        else if (msg.includes('sample prep') || msg.includes('fixation') || msg.includes('fix')) {
            response = '<strong>Sample Preparation</strong><br><br>' +
                '<strong>Fixation:</strong><br>â€¢ PFA (4%): Standard, good morphology<br>â€¢ Methanol: Good for cytoskeleton<br>â€¢ Glutaraldehyde: Best ultrastructure<br><br>' +
                '<strong>Permeabilization:</strong><br>â€¢ Triton X-100 (0.1-0.5%): Strong<br>â€¢ Saponin (0.1%): Gentle<br><br>' +
                '<strong>Mounting:</strong> ProLong Gold/Diamond, Vectashield<br><br>' +
                'ðŸ’¡ <em>Always use #1.5 coverslips (170Î¼m) for high-NA objectives!</em>';
        }
        
        // FLUOROPHORES
        else if (msg.includes('fluorophore') || msg.includes('dye') || msg.includes('alexa')) {
            response = '<strong>Fluorophore Selection</strong><br><br>' +
                '<strong>By color:</strong><br>â€¢ Blue: DAPI, Hoechst (DNA)<br>â€¢ Green: Alexa 488, GFP, ATTO 488<br>â€¢ Orange: Alexa 555, Cy3, mOrange<br>â€¢ Red: Alexa 594/647, mCherry<br><br>' +
                '<strong>For super-resolution:</strong><br>â€¢ STED: ATTO 647N, Abberior STAR<br>â€¢ STORM: Alexa 647 + thiol buffer<br><br>' +
                'ðŸ’¡ <em>Alexa Fluor dyes are brighter and more photostable than Cy dyes.</em>';
        }
        
        // RESOLUTION
        else if (msg.includes('resolution') || msg.includes('diffraction')) {
            response = '<strong>Resolution in Microscopy</strong><br><br>' +
                '<strong>Diffraction limit:</strong> d = Î»/(2Ã—NA)<br>â€¢ ~200nm lateral, ~500nm axial<br><br>' +
                '<strong>Improve with:</strong><br>â€¢ Higher NA objective<br>â€¢ Shorter wavelength<br>â€¢ Deconvolution (~1.4x)<br>â€¢ Super-resolution<br><br>' +
                '<strong>Nyquist:</strong> Pixel size â‰¤ resolution/2.3<br><br>' +
                '<strong>Super-res comparison:</strong> Airyscan 140nm â†’ SIM 100nm â†’ STED 50nm â†’ STORM 20nm';
        }
        ...
        // PROTOCOLS - MICROHUB FEATURE
            ...
            response = 'To find protocols in MicroHub:<br><br>' +
                ...
                '3. On paper pages, see "ðŸ“‹ Protocols" section<br><br>' +
        ...
        // GITHUB
            ...
            response = 'To find code repositories:<br><br>' +
                ...
                '3. On paper pages, see "ðŸ’» Code & Data" section<br><br>' +
        ...
        // SEARCH/FILTER
            ...
            response = '<strong>MicroHub Search Tips</strong><br><br>' +
                ...
                'â€¢ ðŸ† Foundational (100+ citations)<br>' +
                'â€¢ â­ High Impact (50+)<br>' +
                'â€¢ ðŸ“‹ Has Protocols<br>' +
                'â€¢ ðŸ’» Has GitHub<br>' +
                'â€¢ ðŸ’¾ Has Data<br><br>' +
        ...
        // GREETINGS
            ...
            response = 'Hello! ðŸ‘‹ I\'m the MicroHub assistant.<br><br>' +
                'I can help with:<br>' +
                'â€¢ <strong>Techniques:</strong> confocal, STED, STORM, light sheet...<br>' +
                'â€¢ <strong>Software:</strong> ImageJ, Cellpose, CellProfiler...<br>' +
                'â€¢ <strong>Practical tips:</strong> sample prep, dyes, objectives...<br>' +
                'â€¢ <strong>Finding papers:</strong> with protocols or code<br><br>' +
                'What would you like to know?';
        }
        
        else if (msg.includes('thank')) {
            response = 'You\'re welcome! Let me know if you have more questions. ðŸ”¬';
        }
        
        else if (msg.includes('help') || msg.includes('what can you')) {
            response = '<strong>I can help with:</strong><br><br>' +
                'ðŸ”¬ <strong>Techniques:</strong> Confocal, two-photon, STED, STORM, PALM, SIM, light sheet, TIRF, FRET, FLIM, FRAP, cryo-EM<br><br>' +
                'ðŸ’» <strong>Software:</strong> ImageJ/Fiji, CellProfiler, Cellpose, Napari, ilastik, QuPath<br><br>' +
                'ðŸ§ª <strong>Practical:</strong> Sample prep, fluorophores, objectives, resolution<br><br>' +
                'ðŸ“š <strong>Resources:</strong> Finding papers with protocols, GitHub code, data<br><br>' +
                'Just ask!';
        }
        ...
        // DEFAULT
            ...
            response = 'I can help with microscopy research! Try asking about:<br><br>' +
                'â€¢ <strong>Techniques:</strong> "How does confocal work?" or "Compare STED vs STORM"<br>' +
                'â€¢ <strong>Software:</strong> "What is Cellpose?" or "How to use ImageJ"<br>' +
                'â€¢ <strong>Tips:</strong> "Best dyes for STED" or "Sample preparation"<br>' +
                'â€¢ <strong>Resources:</strong> "Find papers with protocols"<br><br>' +
                'What would you like to know?';
        }
    ...
    MicroHub.createPaperCard = function(paper) {
        ...
        if (citations >= 100) { badgeClass = 'foundational'; badgeText = 'ðŸ† Foundational'; }
        else if (citations >= 50) { badgeClass = 'high-impact'; badgeText = 'â­ High Impact'; }
        ...
        if (paper.microscopes && paper.microscopes.length > 0) {
            tagsHtml += '<span class="mh-card-tag microscope">ðŸ”¬ ' + this.escapeHtml(paper.microscopes[0]) + '</span>';
        }
        if (paper.software && paper.software.length > 0) {
            tagsHtml += paper.software.slice(0, 2).map(function(s) {
                return '<span class="mh-card-tag software">ðŸ’» ' + MicroHub.escapeHtml(s) + '</span>';
            }).join('');
        }

        var enrichmentHtml = '';
        var items = [];
        if (paper.protocols && paper.protocols.length) items.push('<span class="mh-enrichment-item protocols">ðŸ“‹ ' + paper.protocols.length + '</span>');
        if (paper.github_url) items.push('<span class="mh-enrichment-item github">ðŸ’» GitHub</span>');
        if (paper.repositories && paper.repositories.length) items.push('<span class="mh-enrichment-item repositories">ðŸ’¾ Data</span>');
        if (paper.facility) items.push('<span class="mh-enrichment-item facility">ðŸ›ï¸ Facility</span>');
        ...
        return '<article class="mh-paper-card' + (paper.thumbnail_url ? ' has-thumbnail' : '') + '">' +
            ...
            '<div class="mh-card-footer">' +
                ...
                '<div class="mh-card-actions">' +
                    '<span class="mh-card-action">ðŸ’¬ ' + commentsCount + '</span>' +
                    '<span class="mh-card-action mh-ai-discuss" data-title="' + this.escapeHtml(paper.title) + '">ðŸ¤– Ask AI</span>' +
                '</div>' +
            '</div>' +
            '</div>' +
        '</article>';
    ...
    MicroHub.renderPagination = function(total, totalPages) {
        ...
        html += '<button data-page="' + (current - 1) + '" ' + (current === 1 ? 'disabled' : '') + '>â† Prev</button>';
        ...
        html += '<button data-page="' + (current + 1) + '" ' + (current === totalPages ? 'disabled' : '') + '>Next â†’</button>';
     ...
     * Full Text Controls
     */
    MicroHub.initFullTextControls = function() {
        var highlightToggle = document.getElementById('mh-toggle-highlights');
        var expandToggle = document.getElementById('mh-expand-text');
        var fullTextContent = document.getElementById('mh-full-text-content');
        ...
        if (highlightToggle && fullTextContent) {
            highlightToggle.addEventListener('click', function() {
                ...
                var highlightOn = this.querySelector('.highlight-on');
                var highlightOff = this.querySelector('.highlight-off');
        ...
        document.querySelectorAll('.mh-ref-link').forEach(function(link) {
    ...
    $(document).ready(function() {
        ...
        // Always init full text controls on single paper pages
        MicroHub.initFullTextControls();
    });
