 ...
 * Matches the paper template structure exactly with sidebar layout
 */
get_header();
...
$protocol_type = get_post_meta(get_the_ID(), '_mh_protocol_type', true);
if (empty($protocol_type)) {
    $protocol_type_terms = wp_get_object_terms(get_the_ID(), 'mh_protocol_type', array('fields' => 'names'));
    ...
    <div class="mh-layout-sidebar">
        ...
        <div class="mh-paper-content">
            ...
            <header class="mh-paper-header">
                ...
                <div class="mh-protocol-type-badge">
                    <?php echo esc_html($protocol_type); ?>
                </div>
                <?php endif; ?>
            ...
            <!-- GitHub -->
            <?php mh_display_github($meta['github_url']); ?>
            ...
            <section class="mh-paper-section">
                ...
                <p style="color: var(--text-muted); margin-bottom: 16px; font-size: 0.9rem;">Verified research resources used in this protocol:</p>
                ...
                <div class="mh-comment-form">
                    ...
                    <form action="<?php echo esc_url(site_url('/wp-comments-post.php')); ?>" method="post">
                        ...
                        <div class="mh-form-group">
                            ...
                            <textarea name="comment" rows="4" required placeholder="Share your thoughts on this protocol..."></textarea>
                        </div>
        ...
        <aside class="mh-sidebar">
            ...
            <div class="mh-sidebar-widget">
                ...
                <div class="mh-stats-list">
                    ...
                    <div class="mh-stat-row">
                        <span class="mh-stat-label">Type</span>
                        <span class="mh-stat-value"><?php echo esc_html($protocol_type); ?></span>
                    </div>
                    <?php endif; ?>
            ...
            <div class="mh-sidebar-widget">
                ...
                <div style="display: flex; flex-direction: column; gap: 8px;">
                    <?php if ($meta['github_url']): ?>
                        <a href="<?php echo esc_url($meta['github_url']); ?>" class="mh-btn mh-btn-github" target="_blank" style="justify-content: center;">🐙 View Code</a>
                    <?php endif; ?>
                    <?php if ($meta['pdf_url']): ?>
            ...
            <!-- Analysis Software -->
            <?php
            if (taxonomy_exists('mh_analysis_software')) {
                $analysis_sw = get_the_terms(get_the_ID(), 'mh_analysis_software');
                if ($analysis_sw && !is_wp_error($analysis_sw)):
            ?>
            <div class="mh-sidebar-widget">
                <h3>📊 Analysis Software</h3>
                <div class="mh-tags">
                    <?php foreach ($analysis_sw as $term):
                        $link = get_term_link($term);
                        if (!is_wp_error($link)):
                    ?>
                        <a href="<?php echo esc_url($link); ?>" class="mh-tag mh-tag-software"><?php echo esc_html($term->name); ?></a>
            ...
            <?php
            if (taxonomy_exists('mh_acquisition_software')) {
                $acquisition_sw = get_the_terms(get_the_ID(), 'mh_acquisition_software');
                if ($acquisition_sw && !is_wp_error($acquisition_sw)):
            ?>
            <div class="mh-sidebar-widget">
                <h3>📷 Acquisition Software</h3>
                <div class="mh-tags">
                    <?php foreach ($acquisition_sw as $term):
                        $link = get_term_link($term);
                        if (!is_wp_error($link)):
                    ?>
                        <a href="<?php echo esc_url($link); ?>" class="mh-tag mh-tag-software"><?php echo esc_html($term->name); ?></a>
            ...
            <!-- Fluorophores (from taxonomy) -->
            <?php
            if (taxonomy_exists('mh_fluorophore')) {
                $fluorophores_tax = get_the_terms(get_the_ID(), 'mh_fluorophore');
                if ($fluorophores_tax && !is_wp_error($fluorophores_tax)):
            ?>
            <div class="mh-sidebar-widget">
                <h3>✨ Fluorophores</h3>
                <div class="mh-tags">
            ...
            <!-- Cell Lines (from taxonomy) -->
            <?php
            if (taxonomy_exists('mh_cell_line')) {
                $cell_lines_tax = get_the_terms(get_the_ID(), 'mh_cell_line');
                if ($cell_lines_tax && !is_wp_error($cell_lines_tax)):
            ?>
            <div class="mh-sidebar-widget">
                <h3>🧫 Cell Lines</h3>
                <div class="mh-tags">
            ...
            <!-- Sample Preparation (from taxonomy) -->
            <?php
            if (taxonomy_exists('mh_sample_prep')) {
                $sample_prep_tax = get_the_terms(get_the_ID(), 'mh_sample_prep');
                if ($sample_prep_tax && !is_wp_error($sample_prep_tax)):
            ?>
            <div class="mh-sidebar-widget">
            ...
            <!-- Microscope Models (from meta) -->
            <?php
            $models = json_decode(get_post_meta(get_the_ID(), '_mh_microscope_models', true), true) ?: array();
            if (!empty($models)):
            ?>
            <div class="mh-sidebar-widget">
                <h3>🔬 Microscope Models</h3>
                <div class="mh-tags">
                    <?php foreach ($models as $model): ?>
                        <span class="mh-tag mh-tag-microscope_model"><?php echo esc_html($model); ?></span>
                    <?php endforeach; ?>
                </div>
            </div>
            <?php endif; ?>
            ...
            if (taxonomy_exists('mh_facility')) {
                $facilities = get_the_terms(get_the_ID(), 'mh_facility');
            ...
            <div class="mh-sidebar-widget">
                ...
                <div class="mh-tags">
                    <?php foreach ($facilities as $term):
                        ...
                        if (!is_wp_error($link)):
                    ?>
                        <a href="<?php echo esc_url($link); ?>" class="mh-tag mh-tag-facility"><?php echo esc_html($term->name); ?></a>
                    <?php endif; endforeach; ?>
                </div>
            </div>
            <?php endif;
