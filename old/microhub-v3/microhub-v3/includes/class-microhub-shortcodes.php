...
class MicroHub_Shortcodes {
    ...
    private function render_navigation() {
        ...
        $nav_items = array(
            array('url' => home_url('/microhub/'), 'label' => '🔬 Search', 'icon' => ''),
            array('url' => home_url('/discussions/'), 'label' => '💬 Discussions', 'icon' => ''),
            array('url' => home_url('/upload-protocol/'), 'label' => '📤 Upload', 'icon' => ''),
            array('url' => home_url('/about/'), 'label' => 'ℹ️ About', 'icon' => ''),
            array('url' => home_url('/contact/'), 'label' => '📧 Contact', 'icon' => ''),
        );
        
        $html = '<nav class="mh-main-nav">';
        $html .= '<div class="mh-nav-inner">';
        $html .= '<a href="' . home_url('/microhub/') . '" class="mh-nav-logo">🔬 MicroHub</a>';
        ...
        <div class="microhub-wrapper">
                        ...
                        <div class="mh-hero-content">
                            ...
                            <div class="mh-featured-papers">
                                ...
                                <div class="mh-featured-paper">
                                    <span class="mh-featured-badge">🏆 Featured Paper</span>
                                    ...
                                    <div class="mh-featured-meta">
                                        ...
                                        <?php if ($journal) echo ' • ' . esc_html($journal); ?>
                                    ...
                                    <div class="mh-featured-stats">
                                        ...
                                        <?php if (!empty($techniques)) : ?>
                                            <span>🔬 <?php echo esc_html($techniques[0]); ?></span>
                                        <?php endif; ?>
                                    </div>
                                </div>
                                <?php endforeach; ?>
            ...
            <section class="mh-results-section">
                ...
                <aside class="mh-sidebar">
                    ...
                    <!-- Quick Stats -->
                    <div class="mh-sidebar-widget">
                        <h3><span class="icon">📊</span> Repository Stats</h3>
    ...
    private function render_ai_chat_widget() {
        ...
        <div class="mh-ai-chat-panel" id="mh-ai-panel">
            <div class="mh-ai-chat-header">
                <h4>🤖 Ask Gemini AI</h4>
                <button class="mh-ai-chat-close" id="mh-ai-close">×</button>
            </div>
            <div class="mh-ai-context" id="mh-ai-context">
                Context: Browsing microscopy research papers
            </div>
            <div class="mh-ai-chat-messages" id="mh-ai-messages">
                <div class="mh-ai-message assistant">
                    Hi! I'm here to help you explore microscopy research. Ask me about techniques, papers, protocols, or anything microscopy-related!
                </div>
            </div>
            <div class="mh-ai-chat-input">
                <input type="text" id="mh-ai-input" placeholder="Ask about microscopy..." />
                <button id="mh-ai-send">Send</button>
            </div>
        </div>
        <?php
        return ob_get_clean();
                ...
                <div class="mh-forum-topics">
                    <?php if ($discussions) : ?>
                        ...
                        <div class="mh-forum-topic">
                            <div class="mh-forum-topic-icon"><?php echo $icons[$category] ?? '💬'; ?></div>
                            <div class="mh-forum-topic-content">
                                ...
                                <div class="mh-forum-topic-meta">
                                    Started by <?php echo esc_html($author->display_name ?? 'Anonymous'); ?> • 
                                    <?php echo human_time_diff(get_the_time('U', $topic), current_time('timestamp')); ?> ago
                                </div>
                            </div>
                            <div class="mh-forum-topic-stats">
                                <span>💬 <?php echo $replies; ?> replies</span>
                                <span>👁 <?php echo get_post_meta($topic->ID, '_mh_views', true) ?: 0; ?> views</span>
                            </div>
                        </div>
                        <?php endforeach; ?>
                    <?php else : ?>
                ...
                <form class="mh-upload-form" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mh-form-group">
                        ...
                        <div class="mh-dropzone" onclick="document.getElementById('protocol-file').click()">
                            <div class="mh-dropzone-icon">📄</div>
                    ...
                    <button type="submit" class="mh-submit-btn">📤 Upload Protocol</button>
                </form>
            </section>
        </div>
        <?php
        ...
        <div class="microhub-wrapper">
            <section class="mh-upload-section">
                ...
                <form class="mh-upload-form" method="post">
                    ...
                    <button type="submit" class="mh-submit-btn">📤 Submit Paper</button>
                </form>
            </section>
        </div>
        <?php
    ...
    private function handle_protocol_upload() {
        ...
        if ($post_id && !is_wp_error($post_id)) {
            ...
            echo '<div style="background: #238636; color: white; padding: 16px; border-radius: 8px; margin-bottom: 20px;">✅ Protocol submitted successfully! It will be reviewed and published soon.</div>';
        }
    }
        ...
        <article class="mh-paper-card">
            ...
            <div class="mh-card-enrichment">
                <?php if (!empty($protocols)) : ?>
                    <span class="mh-enrichment-item protocols">📋 <?php echo count($protocols); ?> Protocol<?php echo count($protocols) > 1 ? 's' : ''; ?></span>
                <?php endif; ?>
                <?php if ($github_url) : ?>
                ...
                <?php endif; ?>
                <?php if ($facility) : ?>
                    <span class="mh-enrichment-item facility">🏛️ Facility</span>
                <?php endif; ?>
            </div>
            ...
            <div class="mh-card-footer">
                ...
                <div class="mh-card-actions">
                    <span class="mh-card-action" data-paper-id="<?php echo $post_id; ?>">💬 <?php echo $comments_count; ?></span>
                    <span class="mh-card-action mh-ai-discuss" data-title="<?php echo esc_attr(get_the_title($post_id)); ?>">🤖 Ask AI</span>
                </div>
            </div>
        </article>
        <?php
