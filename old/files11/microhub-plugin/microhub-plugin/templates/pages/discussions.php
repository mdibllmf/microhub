<?php
/**
 * Discussions Page Template for MicroHub (Shortcode Version)
 ...
 * 
 * NOTE: This template is loaded via shortcode, so no get_header()/get_footer()
 */
            ...
            <aside class="mh-discussions-sidebar">
                ...
                <div class="mh-sidebar-widget">
                    ...
                    <ul style="display: flex; flex-direction: column; gap: 8px;">
                        ...
                        <?php if (function_exists('mh_get_page_url')): ?>
