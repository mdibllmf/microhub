...
(function($) {
    ...
    MicroHub.initFullTextControls = function() {
        ...
        var expandAllToggle = document.getElementById('mh-expand-all-sections');
        if (expandAllToggle) {
            expandAllToggle.addEventListener('click', function() {
                var sections = document.querySelectorAll('.mh-section-block');
                var expandAll = this.querySelector('.expand-all');
                var collapseAll = this.querySelector('.collapse-all');
                
                var allExpanded = Array.from(sections).every(function(s) {
                    return s.classList.contains('mh-section-expanded');
                });
    ...
    MicroHub.toggleSection = function(header) {
        var block = header.closest('.mh-section-block');
        if (block) {
