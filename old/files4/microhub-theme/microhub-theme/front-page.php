...
<!-- Protocols and Facilities Sidebar Section -->
<?php
...
// Get recent protocols with URLs
$recent_protocols = mh_get_recent_protocol_urls(8);
?>
<section class="mh-sidebar-section">
    <div class="mh-container">
        <div class="mh-sidebar-grid">
            ...
            <div class="mh-sidebar-widget">
                ...
                <ul class="mh-facility-list">
                    ...
                    <li class="mh-facility-item">
                        <a href="<?php echo esc_url(add_query_arg('s', $facility['name'], home_url('/'))); ?>" class="facility-link">
                            <?php echo esc_html(wp_trim_words($facility['name'], 8)); ?>
                        </a>
            ...
            <!-- Protocol Sources Widget -->
            <div class="mh-sidebar-widget">
                <h3><span class="icon">🔗</span> Protocol Sources</h3>
                <?php if (!empty($recent_protocols)) : ?>
                <ul class="mh-protocol-list">
                    <?php foreach ($recent_protocols as $protocol) : ?>
                    <li class="mh-protocol-item">
                        <a href="<?php echo esc_url($protocol['url']); ?>" class="protocol-link" target="_blank">
                            <span class="protocol-icon">🔗</span>
                            <?php echo esc_html(wp_trim_words($protocol['title'], 6)); ?>
                        </a>
                ...
                <?php else : ?>
                <p class="mh-empty-item">No protocol links found</p>
                <?php endif; ?>
            </div>
        </div>
    </div>
...
@media (max-width: 1024px) { .mh-papers-grid { grid-template-columns: repeat(2, 1fr); } }
@media (max-width: 640px) { .mh-papers-grid { grid-template-columns: 1fr; } }
...
.mh-protocol-item .protocol-icon {
    opacity: 0.6;
    flex-shrink: 0;
}
