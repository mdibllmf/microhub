...
<div class="microhub-wrapper">
        ...
        <div class="mh-paper-content">
                    ...
                    <div class="mh-repo-list">
                        <?php foreach ($repos as $repo) : ?>
                            <a href="<?php echo esc_url($repo['url'] ?? '#'); ?>" class="mh-repo-item" target="_blank">
                                <span><?php echo esc_html($repo['name'] ?? 'View Data'); ?></span>
                            </a>
                        <?php endforeach; ?>
                    </div>
                </section>
            ...
            <aside class="mh-paper-sidebar">
                ...
                <div class="mh-sidebar-widget">
                    <h3>🤖 Ask AI</h3>
                    <p style="color: #8b949e; font-size: 0.85rem; margin-bottom: 12px;">Have questions about this paper?</p>
                    <button class="mh-ai-discuss-btn" data-title="<?php echo esc_attr(get_the_title()); ?>" style="width: 100%; padding: 10px; background: linear-gradient(135deg, #4285f4, #34a853); border: none; border-radius: 6px; color: white; font-weight: 600; cursor: pointer;">
                        Ask Gemini AI
                    </button>
                </div>
    ...
    <div class="mh-ai-chat-panel" id="mh-ai-panel">
        ...
        <div class="mh-ai-context" id="mh-ai-context">
            Context: <?php echo esc_html(get_the_title()); ?>
        </div>
        <div class="mh-ai-chat-messages" id="mh-ai-messages">
            <div class="mh-ai-message assistant">
                Hi! I can help you understand this paper. Ask me about the methods, results, or how to apply these techniques!
            </div>
        </div>
        <div class="mh-ai-chat-input">
            <input type="text" id="mh-ai-input" placeholder="Ask about this paper..." />
