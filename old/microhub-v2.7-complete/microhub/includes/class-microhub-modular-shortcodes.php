...
class MicroHub_Modular_Shortcodes {
    ...
    public function ai_chat_shortcode($atts) {
        ...
        <div class="mh-ai-chat mh-chat-<?php echo esc_attr($atts['position']); ?>" id="mh-ai-chat">
            ...
            <div class="mh-chat-messages" id="mh-chat-messages">
                <div class="mh-chat-message assistant">
                    <p>Hi! I'm here to help you explore microscopy research. Ask me about techniques, papers, protocols, or anything microscopy-related!</p>
                </div>
            </div>
            <div class="mh-chat-input">
                <input type="text" id="mh-chat-input" placeholder="Ask a question..." />
                <button type="button" id="mh-chat-send">Send</button>
            </div>
        </div>
        <?php
        return ob_get_clean();
