        ...
        <div class="mh-contact-layout">
            <div class="mh-contact-info">
                ...
                <div class="mh-info-card">
                    <h3>💡 Common Topics</h3>
                    <ul>
                        <li>🔬 <strong>Paper Submissions</strong> - Submit papers we may have missed</li>
                        <li>📋 <strong>Protocol Uploads</strong> - Share your protocols with the community</li>
                        <li>🐛 <strong>Bug Reports</strong> - Help us improve the platform</li>
                        <li>🤝 <strong>Collaborations</strong> - Partner with us on research initiatives</li>
                        <li>📊 <strong>Data Requests</strong> - Custom data exports or API access</li>
                    </ul>
                </div>
                ...
                <div class="mh-info-card">
                    <h3>🔗 Quick Links</h3>
                    <ul>
                        <li><a href="<?php echo esc_url($urls['discussions']); ?>">💬 Discussion Forum</a></li>
                        <li><a href="<?php echo esc_url($urls['upload-protocol']); ?>">📤 Upload Protocol</a></li>
                        <li><a href="<?php echo esc_url($urls['upload-paper']); ?>">📄 Submit Paper</a></li>
                        <li><a href="<?php echo esc_url($urls['about']); ?>">ℹ️ About MicroHub</a></li>
                    </ul>
                </div>
            </div>
