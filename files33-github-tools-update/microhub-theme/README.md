...
- **Copilot AI Chat**: Global AI assistant on all pages
...
- Copilot API key (optional, for AI chat)
...
### Copilot AI Chat
The theme uses the MicroHub plugin's Copilot integration. Configure the API key in:
1. Go to **MicroHub → Settings** in WordPress admin
2. Enter your Copilot API key from [Google AI Studio](https://copilot.studio.microsoft.com)
...
├── template-parts/
│   └── copilot-chat.php    # AI chat widget
└── assets/
    └── js/
        └── main.js        # JavaScript
```
