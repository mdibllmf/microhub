        ...
        <div class="mh-ai-messages" id="aiChatMessages">
            <div class="mh-ai-message mh-ai-bot">
                <div class="mh-ai-message-content">
                    <p>Hi! I'm the MicroHub Assistant - your expert microscopy research consultant. I can help you:</p>
                    <ul>
                        <li><strong>Design protocols</strong> with step-by-step methods & citations</li>
                        <li><strong>Adapt methods</strong> to your microscope & organism</li>
                        <li><strong>Find papers</strong> with specific techniques & settings</li>
                        <li><strong>Troubleshoot</strong> imaging problems with evidence-based solutions</li>
                        <li><strong>Compare techniques</strong> for your specific application</li>
                    </ul>
                    <p>Tell me what you're trying to image and what equipment you have!</p>
                </div>
            </div>
        </div>
        
        <div class="mh-ai-suggestions" id="aiChatSuggestions">
            <button class="mh-ai-suggestion" data-query="I need a protocol for immunofluorescence staining of neurons">IF protocol</button>
            <button class="mh-ai-suggestion" data-query="What settings should I use for live cell confocal imaging?">Live imaging settings</button>
            <button class="mh-ai-suggestion" data-query="Compare STED vs SIM for my application">Compare SR methods</button>
            <button class="mh-ai-suggestion" data-query="How do I optimize my zebrafish embryo imaging?">Zebrafish imaging</button>
        </div>
...
.mh-ai-message-content h3,
.mh-ai-message-content h4 {
    color: #c4b5fd;
    margin: 16px 0 8px 0;
    font-size: 14px;
    font-weight: 600;
...
.mh-ai-message-content h3:first-child,
.mh-ai-message-content h4:first-child {
    margin-top: 0;
}

.mh-ai-message-content code {
...
(function() {
    ...
    // Get API URL from WordPress - use the plugin's AI chat endpoint
    // microhubAjax is defined by the theme, contains aiChatUrl for the AI chat endpoint
    let apiUrl = '/wp-json/microhub/v1/ai-chat';
    if (typeof microhubAjax !== 'undefined' && microhubAjax.aiChatUrl) {
        apiUrl = microhubAjax.aiChatUrl;
    }
    ...
    function formatMessage(text) {
        ...
        // Clean up empty paragraphs around headers and lists
