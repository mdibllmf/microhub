...
class MicroHub_Taxonomies {
    ...
    /**
     * Static method to register taxonomies directly (for activation hook)
     */
    ...
    public function register_taxonomies() {
        ...
        // Register Imaging Facility taxonomy (non-hierarchical)
        // For tracking imaging cores, facilities, and research centers
        register_taxonomy('mh_facility', array('mh_paper', 'mh_protocol'), array(
            'labels' => array(
                'name' => __('Imaging Facilities', 'microhub'),
                'singular_name' => __('Imaging Facility', 'microhub'),
        ...
        // Register Protocol Type taxonomy (hierarchical) - applies to BOTH papers and protocols
        // Papers from protocol journals (JoVE, Nature Protocols, etc.) get tagged here
        register_taxonomy('mh_protocol_type', array('mh_paper', 'mh_protocol'), array(
            'labels' => array(
